...
import com.jovanovic.stefan.sqlitetutorial.CapTK;
import com.jovanovic.stefan.sqlitetutorial.Duyet_KN;
...
import com.jovanovic.stefan.sqlitetutorial.TraCuu;
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(username.equals("admin") && password.equals("admin") ){
                    Intent intentad = new Intent(Dang_nhap.this, CapTK.class);
                ...
                int userLevel = Integer.parseInt(acc.getBacTK());
                switch(userLevel) {
                    case 1: // Bậc 1
                    ...
                    case 2: // Bậc 2
                        ...
                        break;
                    case 3: // Bậc 3
                        Intent intent3 = new Intent(Dang_nhap.this, Duyet_KN.class);
